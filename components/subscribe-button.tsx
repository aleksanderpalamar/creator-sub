...
export function SubscribeButton({ creatorId, planId, disabled = false }: SubscribeButtonProps) {
  ...
  async function copyToClipboard(text: string) {
    try {
      ...
      toast.error("Não foi possível copiar o código. Por favor, copie manualmente.")
    }
  }
      ...
      <DialogContent className="sm:max-w-md">
        ...
        {paymentInfo ? (
          <div className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground">Este código expira em: {paymentInfo.expirationDate}</p>
